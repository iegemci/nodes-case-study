...
import com.enesgemci.mymovies.view.adapter.DefaultSuggestionsAdapter;
...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
        Animation.AnimationListener, SuggestionsAdapter.ItemInteractionListener,
    ...
    private CharSequence originalPlaceholderText;
    ...
    private void init(AttributeSet attrs) {
        ...
        originalPlaceholderText = placeholderText;
        ...
        if (adapter instanceof DefaultSuggestionsAdapter) {
            ((DefaultSuggestionsAdapter) adapter).addListener(this);
        }
    ...
    public void disableSearch() {
        ...
        if (originalPlaceholderText != null) {
            if (adapter.getItemCount() > 0) {
                setPlaceHolder(placeholderText);
            } else {
                setPlaceHolder(originalPlaceholderText);
            }
     ...
     */
    public void addSuggestionsClickListener(SuggestionsAdapter.ItemInteractionListener listener) {
        if (adapter instanceof DefaultSuggestionsAdapter)
            ((DefaultSuggestionsAdapter) adapter).addListener(listener);
    }
    ...
    @Override
    public void onItemDeleted(int position, View v) {
        if (v.getTag() instanceof String) {
    ...
    public interface OnSearchActionListener {
         ...
         */
        void onSearchConfirmed(@NonNull String text);
